...
export default function AdminAccount() {
  const [accounts, setAccounts] = useState([]); // Thêm state để lưu trữ danh sách tài khoản admin
  ...
  useEffect(() => {
    // Gọi API để lấy danh sách tài khoản admin từ Server
...
// import { datauser } from 'src/data/fakedata'
